codeunit 50101 "B2 Pro Interface"
{
    ...
    procedure createHeaderItemCSV(var lineNoP: Integer; var csvBufferP: record "CSV Buffer"; proID: text)
    begin
        lineNoP := 1;
        csvBufferP.InsertEntry(lineNoP, 1, format(0));
        csvBufferP.InsertEntry(lineNoP, 2, proID);
    end;
    ...
    local procedure CreateVendorCSV(var vendorP: record Vendor; var lineNoP: Integer; modifyP: Boolean; var csvBufferP: record "CSV Buffer")
    begin
    ...
    /*
        ...
        TYPE DE LIGNE	O	Chaîne	1	Constante = 0
CODE TIERS	O	Chaîne	15	Code tiers du fournisseur
Constante 
